...
public class ByteKeyRangeTrackerTest {
  ...
  public void testCheckpointClaimedLast() throws Exception {
    ...
    // ByteKey validates that endKey is bigger than startKey
    assertEquals(ByteKeyRange.of(ByteKey.of(0xc0), ByteKey.of(0xc1)), checkpoint);
  }
  ...
  public void testNextByteKey() {
    assertEquals(ByteKeyRangeTracker.next(ByteKey.EMPTY, ByteKeyRange.ALL_KEYS), ByteKey.of(0x00));
    assertEquals(
        ByteKeyRangeTracker.next(ByteKey.EMPTY, ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0x00));
    assertEquals(
        ByteKeyRangeTracker.next(ByteKey.EMPTY, ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xff))),
        ByteKey.of(0x00));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.EMPTY, ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0x10, 0x10))),
        ByteKey.of(0x00));
    assertEquals(
        ByteKeyRangeTracker.next(ByteKey.EMPTY, ByteKeyRange.of(ByteKey.of(0xa0), ByteKey.EMPTY)),
        ByteKey.EMPTY);
    assertEquals(
        ByteKeyRangeTracker.next(ByteKey.EMPTY, ByteKeyRange.of(ByteKey.of(0xff), ByteKey.EMPTY)),
        ByteKey.EMPTY);
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.EMPTY, ByteKeyRange.of(ByteKey.of(0x10, 0x10), ByteKey.EMPTY)),
        ByteKey.EMPTY);
    assertEquals(
        ByteKeyRangeTracker.next(ByteKey.of(0x00), ByteKeyRange.ALL_KEYS), ByteKey.of(0x01));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.of(0x10), ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0x11));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.of(0x99), ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0x9a));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.of(0x9f), ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0xa0));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.of(0xff), ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0x01, 0x00));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.of(0x10, 0x10), ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0x10, 0x11));
    assertEquals(
        ByteKeyRangeTracker.next(
            ByteKey.of(0x00, 0xff), ByteKeyRange.of(ByteKey.EMPTY, ByteKey.of(0xa0))),
        ByteKey.of(0x01, 0x00));
  }
}
